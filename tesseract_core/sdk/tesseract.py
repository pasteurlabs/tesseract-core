...
class Tesseract:
    ...
    @classmethod
    def from_url(cls, url: str, output_path: str | Path | None = None) -> Tesseract:
        ...
        Args:
            ...
            output_path: Path where binary output files are stored when using json+binref.
        ...
        obj._lastlog = None
        obj._client = HTTPClient(url, output_path=output_path)
        return obj
