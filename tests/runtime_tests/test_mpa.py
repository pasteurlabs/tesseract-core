...
class TestBackendSelection:
    ...
    def test_file_backend_empty_mlflow_uri(self):
...
class TestFileBackend:
    """Test FileBackend functionality with content verification."""

    def test_custom_log_directory(self, tmpdir):
    ...
    def test_log_parameter_content(self):
    ...
    def test_log_metric_content(self):
    ...
    def test_log_artifact_content(self, tmpdir):
