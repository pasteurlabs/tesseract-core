...
def evaluate(inputs: Any) -> Any:
    ...
    # Convert predictions to list of torch tensors
    qoi_predictions = [torch.tensor(pred, dtype=torch.float32) for pred in predictions]

    # TODO: dump predictions to output with references?
    return {
        "qoi": qoi_predictions
    }
